...
var NewBeerForm = function (_a) {
    var refreshBeers = _a.refreshBeers, setIsLoading = _a.setIsLoading, setIsModalOpen = _a.setIsModalOpen, setModalContent = _a.setModalContent;
    var _b = React.useState(0.0), newBeerAbv = _b[0], setNewBeerAbv = _b[1];
    var _c = React.useState(""), newBeerBrewer = _c[0], setNewBeerBrewer = _c[1];
    var _d = React.useState(""), newBeerDescription = _d[0], setNewBeerDescription = _d[1];
    var _e = React.useState(""), newBeerName = _e[0], setNewBeerName = _e[1];
    var _f = React.useState(""), newBeerType = _f[0], setNewBeerType = _f[1];
    return (React.createElement("form", { className: "form", id: "new-beer-form", onSubmit: function (e) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        e.preventDefault();
                        setIsLoading(true);
                        return [4 /*yield*/, beer_1.addBeer({
                                abv: newBeerAbv,
        ...
        React.createElement("h3", null, "Add New Beer"),
        React.createElement("label", { htmlFor: "new-beer-abv" }, "ABV"),
